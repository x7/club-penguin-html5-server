...
export class TownScene extends Phaser.Scene {
	...
	create() {
		...
		// town_spotlightleft
		const town_spotlightleft = this.add.image(631, 125, "town", "town/spotlightleft");
		town_spotlightleft.scaleX = 0.6654835096779513;
		town_spotlightleft.scaleY = 0.7154203518108428;
		town_spotlightleft.angle = -30;
		town_spotlightleft.setOrigin(0.5, 1);
		...
		// town_spotlightleft_1
		const town_spotlightleft_1 = this.add.image(774, 125, "town", "town/spotlightleft");
		town_spotlightleft_1.scaleX = 0.6654835096779512;
		town_spotlightleft_1.scaleY = 0.7154203518108428;
		town_spotlightleft_1.angle = 30;
		town_spotlightleft_1.setOrigin(0.5, 1);
